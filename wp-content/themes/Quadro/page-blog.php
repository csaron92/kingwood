							...
							<div id="et_pt_blog">
								...
								<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
									...
									<div class="et_pt_blogentry clearfix">
										...
										<p class="et_pt_blogmeta"><?php _e('Posted','Quadro'); ?> <?php _e('by','Quadro'); ?> <?php the_author_posts_link(); ?> <?php _e('on','Quadro'); ?> <?php the_time(get_option('quadro_date_format')) ?> <?php _e('in','Quadro'); ?> <?php the_category(', ') ?> | <?php comments_popup_link(__('0 comments','Quadro'), __('1 comment','Quadro'), '% '.__('comments','Quadro')); ?></p>
										...
										<?php if (!$et_ptemplate_blogstyle) { ?>
											...
											<a href="<?php the_permalink(); ?>" class="readmore"><span><?php _e('read more','Quadro'); ?></span></a>
										<?php } else { ?>
											<?php the_content(''); ?>
										<?php } ?>
