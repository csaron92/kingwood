			...
			<?php the_post(); ?>
				<div class="post-wrapper">
					...
					<?php if (get_option('quadro_postinfo2') <> '') { ?>
						<div class="articleinfo"><?php _e('Posted','Quadro'); ?> <?php if (in_array('author', get_option('quadro_postinfo2'))) { ?> <?php _e('by','Quadro'); ?> <?php the_author_posts_link(); ?><?php }; ?><?php if (in_array('date', get_option('quadro_postinfo2'))) { ?> <?php _e('on','Quadro'); ?> <?php the_time(get_option('quadro_date_format')) ?><?php }; ?><?php if (in_array('categories', get_option('quadro_postinfo2'))) { ?> <?php _e('in','Quadro'); ?> <?php the_category(', ') ?><?php }; ?><?php if (in_array('comments', get_option('quadro_postinfo2'))) { ?> | <?php comments_popup_link(__('0 comments','Quadro'), __('1 comment','Quadro'), '% '.__('comments','Quadro')); ?><?php }; ?></div>
					<?php }; ?>
					...
					<?php if (get_option('quadro_thumbnails') == 'on') { ?>
						...
						$width = get_option('quadro_thumbnail_width_posts');
						$height = get_option('quadro_thumbnail_height_posts');
						$classtext = '';
					...
					<?php if (get_option('quadro_468_enable') == 'on') { ?>
						<?php if(get_option('quadro_468_adsense') <> '') echo(get_option('quadro_468_adsense'));
							...
							<a href="<?php echo(get_option('quadro_468_url')); ?>"><img src="<?php echo(get_option('quadro_468_image')); ?>" alt="468 ad" class="foursixeight" /></a>
						<?php } ?>	
					<?php } ?>
