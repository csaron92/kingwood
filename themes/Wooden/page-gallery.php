						...
						<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							...
							<div class="et_pt_gallery_entry">
								<div class="et_pt_item_image">
									...
									<a class="fancybox zoom-icon" title="<?php the_title(); ?>" rel="gallery" href="<?php echo($thumbnail['fullpath']); ?>"><?php _e('Zoom in','Wooden'); ?></a>
									<a class="more-icon" href="<?php the_permalink(); ?>"><?php _e('Read more','Wooden'); ?></a>
