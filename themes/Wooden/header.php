...
<div id="bgdiv">
	<div id="header">
		...
		<div id="pages">
			...
			<img src="<?php bloginfo('template_directory'); ?>/images/nav-line-<?php echo(get_option('wooden_color_scheme')); ?>.gif" alt="logo" style="float: left; margin-left: 15px; margin-top: 8px;" />
			...
			if ($primaryNav == '') { ?>
				<ul class="<?php echo $menuClass; ?>">
					<?php if (get_option('wooden_home_link') == 'on') { ?>
						<li class="page_item"><a href="<?php bloginfo('url'); ?>"><?php _e('Home','Wooden') ?></a></li>
					<?php }; ?>
