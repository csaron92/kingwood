...
function custom_colors_css(){
	...
	<style type="text/css">
		#wrapper-home { color: #<?php echo(get_option($shortname.'_color_mainfont')); ?>; }
		#left-div a { color: #<?php echo(get_option($shortname.'_color_mainlink')); ?>; }
		#pages li a:link, #pages li a:visited { color: #<?php echo(get_option($shortname.'_color_pagelink')); ?>; }
		#pages li a:hover, #pages li a:active { color: #<?php echo(get_option($shortname.'_color_pagelink_active')); ?>; }
